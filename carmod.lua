local correctKey = "GoldeneScaraufmBoden!-huansohn-fuckyourself-nika"
local keyInput = ""

local function showKeyPrompt()
    local keyPrompt = Instance.new("ScreenGui", game.CoreGui)
...
local Theme = {
	Background = Color3.fromRGB(128, 0, 128), -- Lila
	Glow = Color3.fromRGB(200, 162, 200), -- Helles Lila
...
discordSection:addButton(syn and "Join the Discord server" or "Copy Discord Link", function()
	...
	setclipboard("https://www.discord.com/invite/438YhwSFyQ")
end)
